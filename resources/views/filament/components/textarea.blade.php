...
<div x-data="{
    ...
    {{ $attributes->merge($field?->getExtraFieldWrapperAttributes() ?? [], escape: false)->class(['fi-fo-field', 'fi-fo-field-has-inline-label' => $hasInlineLabel]) }}>
    @if (filled($label) && $labelSrOnly)
        <{{ $labelTag }}
            @if ($labelTag === 'label') for="{{ $id }}"
            @else
                id="{{ $id }}-label" @endif
    ...
    @if (
        !\Filament\Support\is_slot_empty($slot) ||
            $hasError ||
            $aboveContentSchema ||
            $belowContentSchema ||
            $beforeContentSchema ||
        ...
        <div class="fi-fo-field-content-col">
            ...
            @if ($beforeContentSchema || $afterContentSchema)
                <div class="fi-fo-field-content-ctn">
                    ...
                    <div class="fi-fo-field-content relative">
                        {{ $slot }}
